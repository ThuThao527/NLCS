    ...
    <div class="welcome-grid">
      ...
      <div class="text-section">
        <div class="text-content">
          <h1 class="welcome-title">Welcome to CleanPro Hub</h1>
          <p class="welcome-greeting">
            Hello, {{ cleanerName || 'Professional Cleaner' }}!
          </p>
          <div class="welcome-description">
            <p>
              Thank you for being part of our cleaning team. This dashboard helps you manage your schedule, track assignments, and provide exceptional service to our clients.
            </p>
            <p>
              Your dedication to quality cleaning makes a difference in our clients' lives every day.
            </p>
          </div>
