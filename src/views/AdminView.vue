...
const UserViewComponent = defineAsyncComponent(() => 
  import('../components/AdminUserView.vue')
)
const HelperViewComponent = defineAsyncComponent(() => 
  import('../components/AdminHelperView.vue')
)
const AdminBooking = defineAsyncComponent(() => 
  import('../components/AdminBooking.vue')
)
...
const navItems = [
  ...
  { 
    ...
    component: HelperViewComponent, 
    icon: UserIcon 
  },

  { 
    id: 3, 
    name: 'Quản lý phiếu đặt', 
...
const activeComponent = shallowRef(UserViewComponent)
